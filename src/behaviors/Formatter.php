...
use xionglonghua\common\forms\DiffFieldsForm;
 ...
 *      'formatter' => [
 *           'as customFormatter' => 'xionglonghua\common\behaviors\Formatter',
 *       ],
 * pre-1: 注册一下DiffAsset // xionglonghua\common\assets\DiffAsset::register($this);
...
class Formatter extends Behavior
{
    /**
     * 展示两个不同字段的变化的html
     * NOTE: 使用时候必须引入 DiffAsset // xionglonghua\common\assets\DiffAsset::register($this);
     * @see DiffAsset
